...
const PACKAGES = [
  { key: 'essential', name: 'Essential', price: 349, desc: 'Up to 20 photos', forType: 'sale' },
  { key: 'premium', name: 'Premium', price: 449, desc: 'Photos + Video + Floor Plan', forType: 'sale' },
  { key: 'ultimate', name: 'Ultimate', price: 599, desc: 'Full Media Package', forType: 'sale' },
  { key: 'rental', name: 'Rental', price: 196.90, priceLabel: '$179 + GST', desc: '12 professional photos', forType: 'rent' },
];
